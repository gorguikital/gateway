...
import { ProfileService } from 'app/entities/utilisateurdb/profile/profile.service';
import { IProfile, Profile } from 'app/shared/model/utilisateurdb/profile.model';
...
describe('Service Tests', () => {
  describe('Profile Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Profile(0, 'AAAAAAA', 'AAAAAAA');
    });
