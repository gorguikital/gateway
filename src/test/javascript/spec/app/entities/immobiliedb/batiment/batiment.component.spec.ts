...
import { BatimentComponent } from 'app/entities/immobiliedb/batiment/batiment.component';
...
describe('Component Tests', () => {
  describe('Batiment Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.batiments && comp.batiments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
