...
export class AnneeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.anneeService
      ...
      .subscribe(
        (res: HttpResponse<IAnnee[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAnnees(): void {
    this.eventSubscriber = this.eventManager.subscribe('anneeListModification', () => this.loadPage());
  }
